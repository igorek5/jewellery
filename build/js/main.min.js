...
/* harmony import */ var _modules_filter_modal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/filter-modal */ "./js/modules/filter-modal.js");
/* harmony import */ var _vendor_init_swiper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./vendor/init-swiper */ "./js/vendor/init-swiper.js");
/* harmony import */ var _modules_form_validate_init_form_validate__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/form-validate/init-form-validate */ "./js/modules/form-validate/init-form-validate.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_vendor_init_swiper__WEBPACK_IMPORTED_MODULE_5__["initSwiper"])();
    Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])();
    Object(_modules_menu__WEBPACK_IMPORTED_MODULE_2__["setMenuControl"])();
    Object(_modules_accordions_init_accordion__WEBPACK_IMPORTED_MODULE_3__["initAccordions"])();
    Object(_modules_filter_modal__WEBPACK_IMPORTED_MODULE_4__["initFilterModal"])();
    Object(_modules_form_validate_init_form_validate__WEBPACK_IMPORTED_MODULE_6__["initFormValidate"])();
  });
}); // ---------------------------------
...
/***/ "./js/modules/filter-modal.js":
/*!************************************!*\
  !*** ./js/modules/filter-modal.js ***!
  \************************************/
/*! exports provided: initFilterModal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initFilterModal", function() { return initFilterModal; });
var filterButton = document.querySelector('[data-filter="button-open"]');
var modalFilter = document.querySelector('[data-filter="modal-filter"]');
var modalFilterOverlay = document.querySelector('[data-filter="overlay-filter"]');
var closeFilterButton = document.querySelector('[data-filter="close-filter"]');

var isEscEvent = function isEscEvent(evt) {
  return evt.key === 'Escape' || evt.key === 'Esc';
};

var filterEscHandler = function filterEscHandler(evt) {
  if (isEscEvent(evt)) {
    filterCloseHandler(evt);
  }
};

var filterOpenHandler = function filterOpenHandler(evt) {
  evt.preventDefault();
...
var initFilterModal = function initFilterModal() {
  if (!modalFilter) {
    return;
  }
...
/* harmony import */ var _form_validate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./form-validate */ "./js/modules/form-validate/form-validate.js");
...
var pageHeader = document.querySelector('[data-menu="wrapper-open"]');
var toggleMenu = document.querySelector('[data-menu="toggle-menu"]');

var isEscEvent = function isEscEvent(evt) {
  return evt.key === 'Escape' || evt.key === 'Esc';
};

var menuButtonHandler = function menuButtonHandler(evt) {
  evt.preventDefault();
  pageHeader.classList.toggle('is-open');
  document.body.classList.toggle('no-scroll');
};

var menuEscHandler = function menuEscHandler(evt) {
  if (isEscEvent(evt)) {
    evt.preventDefault();
...
/* harmony import */ var _swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./swiper */ "./js/vendor/swiper.js");
/* global Swiper */
